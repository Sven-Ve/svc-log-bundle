 ...
 *     },
 * }
 * @psalm-type SvcLogConfig = array{
 *     min_log_level?: int, // Minimal log level, see documentation for values // Default: 1
 *     enable_ip_saving?: bool, // Should the ip address recorded? Please set to true only if this is allowed in your environment (personal data...) // Default: false
 *     enable_user_saving?: bool, // Should the user id and name recorded? Please set to true only if this is allowed in your environment (personal data...) // Default: false
 *     enable_source_type?: bool, // Do you like different source types? // Default: true
 *     need_admin_for_view?: bool, // Need the user the role ROLE_ADMIN for viewing logs (default yes) // Default: true
 *     need_admin_for_stats?: bool, // Need the user the role ROLE_ADMIN for get statistics (default yes) // Default: true
 *     offset_param_name?: string, // We use offset as url parameter. If this in use, you can choose another name // Default: "offset"
 *     data_provider?: string, // Class of your one data provider to get info about sourceType and sourceID, see documentation // Default: null
 *     logger?: array{ // Optional configuration for default logger, see documentation
 *         use_logger?: bool, // Write log entries to default logger too // Default: false
 *         logger_min_log_level?: int, // Minimal log level to write to logger, see documentation for values (only 3..6 allowed) // Default: 6
 *     },
 *     daily_summary?: array{ // Definition of the daily summary report
 *         definition_class?: string, // Class of your daily summary definition // Default: null
 *         destination_email?: string, // Mail address for the daily summary mail // Default: null
 *         mail_subject?: string, // Subject of the daily summary mail // Default: "Daily summary"
 *     },
 *     kernel_exception_logger?: array{ // Configuration for the (optional) kernel exception logger
 *         use_kernel_logger?: bool, // enable the kernel exception logger // Default: false
 *         default_level?: int, // Default log level (only 4..8 allowed) // Default: 5
 *         critical_level?: int, // Log level for critical errors - http code 500 (only 4..8 allowed) // Default: 6
 *         disable_404_to_logger?: bool, // do not send http 404 to logger (and maybe mail) // Default: false
 *         extra_sleep_time?: int, // adds an extra sleep after every 404 error (in seconds, max. 5) // Default: 0
 *     },
 * }
 * @psalm-type SvcUtilConfig = array{
 *     mailer?: array{
 *         mail_address?: string, // Default sender mail address // Default: "test@test.com"
 *         mail_name?: string, // Default sender name // Default: "Test User"
 *     },
 *     twig_components?: array{
 *         table_default_type?: int, // Default table type // Default: null
 *     },
 * }
 ...
 *     twig?: TwigConfig,
 *     svc_log?: SvcLogConfig,
 *     svc_util?: SvcUtilConfig,
